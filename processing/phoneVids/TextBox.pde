//https://stackoverflow.com/questions/22101669/how-to-get-the-height-of-a-text-field-in-processing
...
void displayWrapped(String str, int fontSize, int w) {
  ...
  for (int i=0; i < myTexts.size(); i++) {
    ...
    text(s, 0, texty);
    if (i != myTexts.size()-1) texty += fontSize+lineSpacing*displayScale;
  }
}
